...
const displaySearchResult = (data) => {
  ...
  document.getElementById("explore-container").textContent = "";
  // error handling
  errorCheck(data);
  // show data
    ...
    div.innerHTML = `
        <div class="card d-flex align-items-center py-2">
          ...
          <div class="card-body">
            ...
            <button onclick="loadExplore('${element.slug}')" class="btn btn-primary btn-lg text-bolder">Explore</button>
          </div>
        </div>`;
        ...
        <div class="col-8">
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              GPS: ${
                details.others?.GPS ? details.others.GPS : "No Data Found"
              }, 
              NFC: ${
                details.others?.NFC ? details.others.NFC : "No Data Found"
              }, 
              Radio: ${
                details.others?.Radio ? details.others.Radio : "No Data Found"
              }, 
              USB: ${
                details.others?.USB ? details.others.USB : "No Data Found"
              }, 
              WLAN: ${
                details.others?.WLAN ? details.others.WLAN : "No Data Found"
              }
            </p>
